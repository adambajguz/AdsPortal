namespace AdsPortal.WebPortal.Services
{
    ...
    public class MediaService : IMediaService
    {
        ...
        public async Task<MediaItemDetails?> GetMediaDetails(Guid id, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                string requestPath = $"{ _applicationConfiguration.ApiUrl}media/get-by-id/{id}";
        ...
        public async Task<MediaItemDetails?> GetMediaDetails(string? path, CancellationToken cancellationToken = default)
        {
            HttpResponseMessage response;
            try
            {
                string requestPath = $"{ _applicationConfiguration.ApiUrl}media/get-by-path/{path}";
