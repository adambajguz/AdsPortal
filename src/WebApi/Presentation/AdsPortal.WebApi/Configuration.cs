namespace AdsPortal.WebApi
{
    ...
    public static class Configuration
    {
        ...
        public static IConfigurationBuilder AddConfigs(this IConfigurationBuilder builder, WebHostBuilderContext hostingContext)
        {
            ...
            builder.AddPersistenceConfigs(hostingContext, diffDirectory)
                   .AddIdentityConfigs(hostingContext, diffDirectory)
                   .AddJobSchedulerConfigs(hostingContext, diffDirectory)
                   .AddMailingConfigs(hostingContext, diffDirectory);
