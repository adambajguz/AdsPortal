...
namespace AdsPortal.WebApi.Persistence.Migrations
{
    ...
    [Migration("20210117152552_AddedAdLastExpirationNotification")]
    partial class AddedAdLastExpirationNotification
    {
            ...
            modelBuilder.Entity("AdsPortal.WebApi.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 1, 17, 0, 0, 0, 0, DateTimeKind.Utc),
                            Email = "admin@adsportal.com",
                            IsActive = true,
                            LastSavedOn = new DateTime(2021, 1, 17, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "Admin",
